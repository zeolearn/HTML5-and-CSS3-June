...
(function () {
    ...
    $(document).ready(function () {
        ...
        // How about reading from a file?
        readAndDisplayImage = function () {
            fs.root.getFile('kl.jpg', {}, function (fileEntry) {
                ...
                fileEntry.file(function (file) {
                    ...
                    reader.onloadend = function (e) {
                        ...
                        var blob = new Blob([this.result], { type: 'image/jpg' });

                        var imgUrl = window.URL.createObjectURL(blob);

                        // xhrResult.innerHTML = '<img src="data:image/jpg;base64,' + imgUrl + '"/>';
                        var imageArea = document.getElementById('xhrImageResult');
